...
| P7-026 | Google Business review monitoring + draft response | M | Reputation | Medium | Heavy | P0-014, P2-034, P2-002, P4-015 |
...
> **ID conflict note:** `freeze-list.md` F-3 had previously reserved P7-026 for the
> "schema versioning strategy" gap. That has been reassigned (file as P7-027 if
> still relevant); P7-026 is the Google Business review monitoring story above.
