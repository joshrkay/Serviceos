...
|----|-------|------|-------|----------|--------------|-------------|
| SD-101 | Persist technician working hours (PG repo + migration 138) | S | Availability / Data | High | Moderate | — |
| SD-102 | Business blackout periods + per-tech daily capacity (repos + migrations 139–140) | S | Availability / Data | High | Moderate | — |
...
| SD-105 | Skills data model — skills, technician_skills (proficiency), job_required_skills (migration 141) | M | Skills / Data | High | Moderate | — |
