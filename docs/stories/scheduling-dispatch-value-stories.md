...
**Allowed files:** `packages/api/src/dispatch/board-query.ts`, `packages/api/test/dispatch/board-query.test.ts`, `packages/web/src/pages/dispatch/DispatchBoard.tsx`, `packages/web/src/components/dispatch/**`, `packages/web/src/types/dispatch.ts`
