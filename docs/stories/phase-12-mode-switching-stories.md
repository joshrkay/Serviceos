# Phase 12 — Supervisor / Tech Mode Switching for the Owner-Operator
...
(1) **Migration 063** in `schema.ts`. Append a single migration entry keyed `'063_create_voice_sessions_and_modes'` containing:
