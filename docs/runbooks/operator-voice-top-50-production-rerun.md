...
**If `--jwt-file` is merged** (recommended — was proven in session but may not be on `main`):
...
**On `main` today** (session mint path — expect auth error on production Clerk):
...
- `/opt/cursor/artifacts/operator-voice-50-v3-prod-20260723-0347/production-retest.json`
