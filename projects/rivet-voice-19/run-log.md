...
| New integration tests assert row + audit event + cross-tenant negative, green in `test:integration` | **Done.** Integration suite went 179 files/925 tests → 188/967 at last full run, with more added since; every new file carries all three assertions. |
