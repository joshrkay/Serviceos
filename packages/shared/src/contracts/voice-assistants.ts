...
export const VOICE_INBOUND_ASSISTANTS = [
  ...
  { id: 'V5', description: 'Appointment updates (time-window/notes changes).', requiredToolsHooks: ['stt', 'tts', 'appointment_lookup', 'proposal_queue', 'human_handoff'], jurisdictionFlags: ['requires_recording_disclosure', 'quiet_hours_restrictions'], proposalTypes: [ProposalType.UPDATE_APPOINTMENT] },
  { id: 'V6', description: 'Estimate draft intake from call details.', requiredToolsHooks: ['stt', 'tts', 'estimate_lookup', 'job_lookup', 'proposal_queue', 'human_handoff'], jurisdictionFlags: ['requires_recording_disclosure'], proposalTypes: [ProposalType.DRAFT_ESTIMATE] },
