...
export function actionClassForProposalType(type: ProposalType): ActionClass {
  switch (type) {
    ...
    case 'add_note':
    case 'attach_job_photo':
    case 'attach_invoice_photo':
