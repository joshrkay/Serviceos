...
const SNAPSHOT: ReadonlyArray<readonly [string, string]> = [
  ...
  // Story 15.2 — speed-to-lead first-response opt-in settings.
  ...
  // Story 10.5 — tenant-scoped customer message templates (renumbered 204→207
  // to clear a migration-number collision with main's 204/205/206 on merge).
  ['207_create_message_templates', 'a38dc2fba90473aec17537126a25c71fbf8461b012531c94ea55c858aa85f71d'],
  // Story 10.2 — tenant-configurable reminder cadence/offsets (renumbered 205→208).
  ['208_tenant_settings_reminder_offsets', '7043e4a221b59d530abd0a9d74ac8dd1a7f13379eeefb9b1749cc2b98368442a'],
];
