...
const SNAPSHOT: ReadonlyArray<readonly [string, string]> = [
  ...
  // a migration-number collision with main's 207 on merge; SQL value unchanged).
  ['208_create_message_templates', 'a38dc2fba90473aec17537126a25c71fbf8461b012531c94ea55c858aa85f71d'],
  // Story 10.2 — tenant-configurable reminder cadence/offsets (renumbered).
  ['209_tenant_settings_reminder_offsets', '7043e4a221b59d530abd0a9d74ac8dd1a7f13379eeefb9b1749cc2b98368442a'],
];
