...
const SNAPSHOT: ReadonlyArray<readonly [string, string]> = [
  ...
  // Merged from main (parallel Epic-3 branches): lifecycle emails + trial,
  // speed-to-lead settings, and the tenant_integrations _enc columns fix.
  ...
  // 204 -> 207 to clear the collision with main's 204-206 above (SQL unchanged).
  ['207_create_corrections', '37eac96b01f69d24106801716fbc9e5ed12d9b708e66877bcda4e7f3781e66d9'],
];
