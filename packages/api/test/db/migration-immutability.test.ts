...
const SNAPSHOT: ReadonlyArray<readonly [string, string]> = [
  ...
  // 207 -> 208 to clear a collision with main's 207_jobs_status (SQL unchanged).
  ['208_create_corrections', '37eac96b01f69d24106801716fbc9e5ed12d9b708e66877bcda4e7f3781e66d9'],
];
