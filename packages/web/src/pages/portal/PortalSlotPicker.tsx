  ...
  return (
    <div className="space-y-4">
      <form onSubmit={loadSlots} className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
        <div>
          <label htmlFor="slot-from" className="block text-sm font-medium text-foreground">From</label>
          <Input
            id="slot-from"
            type="date"
            value={from}
        ...
        <div>
          <label htmlFor="slot-to" className="block text-sm font-medium text-foreground">To</label>
          <Input
            id="slot-to"
            type="date"
            value={to}
      ...
      {slots.length > 0 ? (
        <div>
          <div className="text-sm font-medium text-foreground mb-2">Available times</div>
      ...
      {selected ? (
        <button
          ...
          disabled={confirming}
          className="w-full sm:w-auto rounded-lg bg-success hover:bg-success/90 disabled:opacity-50 text-white font-medium px-4 py-2 text-sm"
        >
          {confirming
            ? 'Requesting…'
